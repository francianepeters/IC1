...
def calculaerro(solnumerica,solnumanterior,npontos,iteracao,erroatual):
    if iteracao == 0:
        erroanterior = 999999
    if iteracao != 0:
...
def avaliaerro(erroanterior,erroatual,npontos,iteracao,parada):
    ...
    if difrelativa <= erroadm:
        parada = 1
    iteracao = iteracao + 1
    return npontos, difrelativa, iteracao, parada, diferro
...
while parada == 0:
    ...
    erroanterior, erroatual, solnumanterior = calculaerro(solnumerica,solnumanterior,npontos,iteracao,erroatual)

    npontos, difrelativa, iteracao, parada, diferro = avaliaerro(erroanterior,erroatual,npontos,iteracao,parada)
